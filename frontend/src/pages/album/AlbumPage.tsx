...
const AlbumPage = () => {
    ...
    const handlePlayAlbum = ()=>{
      ...
      // if not start playing from the beginning
        else{
  ...
  return (
    <div className="h-full">
      ...
      {/* main content */}
      {/* this is just a gradient styling that's why aria-hidden is true */}
      <div className='absolute inset-0 bg-gradient-to-b from-[#5038a0]/80 via-zinc-900/80
					 to-zinc-900 pointer-events-none' aria-hidden= 'true'></div>
